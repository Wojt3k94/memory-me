# Dokument wymagań produktu (PRD) – memory.me

## 1. Przegląd produktu
Projekt memory.me ma na celu umożliwienie użytkownikom szybkiego tworzenia i zarządzania zestawami fiszek edukacyjnych. Aplikacja wykorzystuje modele LLM (poprzez API) do generowania sugestii fiszek na podstawie dostarczonego tekstu.
